 ...
 */
package com.losileeya.mvpdemp.okgo.callback;

import com.google.gson.stream.JsonReader;

import com.losileeya.mvpdemp.okgo.model.BruceResponse;
import com.losileeya.mvpdemp.okgo.model.SimpleResponse;
import com.losileeya.mvpdemp.okgo.utils.Convert;
...
public class JsonConvert<T> implements Converter<T> {
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != BruceResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                BruceResponse lzyResponse = Convert.fromJson(jsonReader, type);
                response.close();
